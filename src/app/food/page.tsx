  ...
  return (
    <div>
      <main className={styles.monospace}>
        ...
        <h3 className={styles["page-date"]}>
          {" "}
          May 26 2007 - October 16, 2025{" "}
        </h3>

        <p style={{ textAlign: "center" }}>
          Chloe is a haribo fanatic and loves fruits of all kinds. She’s
          actually <br />
          really hungry right now and attached food that she has been deprived
          of since coming to Calpoly SLO.
        </p>
