    ...
    <div>
      <main className={styles.monospace}>
        ...
        <p style={{ textAlign: "center", marginBottom: "2em" }}>
          Recently, I went to a Shawn Mendes concert with my friends back in the
          Bay <br /> at the Frost Amphitheater. We camped at 3PM and ended up
          getting really good spots. I met a <br /> lot of new people while
          waiting and the crowd was definitely not dead.
        </p>
